...
type NotificationHandlers struct {
	...
	// result of a rescan request, due to how cbdc may send various rescan
...
func (c *Client) handleNotification(ntfn *rawNotification) {
	...
	case btcjson.BtcdConnectedNtfnMethod:
		...
		if err != nil {
			log.Warnf("Received invalid cbdc connected "+
				"notification: %v", err)
			return
		}
...
//
// NOTE: This is a cbdc extension ported from github.com/decred/dcrrpcclient
...
// parseBchdConnectedNtfnParams parses out the connection status of cbdc
// and bchwallet from the parameters of a cbdcconnected notification.
...
//
// NOTE: This is a cbdc extension and requires a websocket connection.
