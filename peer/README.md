...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/gcash/cbdc/peer)
...
```bash
$ go get -u github.com/gcash/cbdc/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/gcash/cbdc/peer#example-package--NewOutboundPeer)  
