...
var (
	...
	defaultRPCCertFile    = filepath.Join(cbdcHomeDir, "rpc.cert")
...
func loadConfig() (*config, []string, error) {
	...
	if _, err := os.Stat(preCfg.ConfigFile); os.IsNotExist(err) {
		...
		if preCfg.Wallet {
			...
			serverConfigPath = filepath.Join(cbdcHomeDir, "cbdc.conf")
		}
...
// For this it tries to read the config file for the RPC server (either cbdc or
