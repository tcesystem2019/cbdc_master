...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/gcash/cbdc/mining/cpuminer)
=======
...
```bash
$ go get -u github.com/gcash/cbdc/mining/cpuminer
```
