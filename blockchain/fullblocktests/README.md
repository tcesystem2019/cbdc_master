...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/gcash/cbdc/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/gcash/cbdc/blockchain/fullblocktests
```
